...
class LicensePlateElements(object):
    ...
    # 车牌类型
    plate_type_enum = {
        'single_blue': 0, 'single_yellow': 1, 'double_yellow': 2, 'police': 3, 'single_yellow_learner': 4,
        'hk': 5, 'macau': 6, 'army7': 7, 'black_shi': 8, 'black_ling': 9,
        'dishu_st': 10, 'avail': 11, 'army_double': 12, 'small_new_energy': 13, 'big_new_energy': 14,
        'motor_light': 15, 'single_black': 16, 'jun_double': 17, 'jun': 18, 'army8': 19, 'black_gang': 20, 'black_ao': 21, 'motor_st': 22,
        'motor_police': 23, 'motor_shi': 24, 'motor_ling': 25, 'motor_learner': 26, 'double_yellow_trailer': 27, 'double_yellow_coach': 28,
        'dishu_farm': 29, 'old_shi': 30, 'old_ling': 31
    }
